...
pred_classes <- factor(ifelse(pred_probs >= best_threshold, 1, 0), levels = c(0,1))
}

# Ensure reference is factor with same levels

y_test_factor <- factor(y_test, levels = c(0,1))

# Compute confusion matrix

best_cm <- confusionMatrix(pred_classes, y_test_factor, positive="1")
best_cm
