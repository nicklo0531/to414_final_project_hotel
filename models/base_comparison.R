...
# Function: evaluate model at threshold
...
# Sweep thresholds for all models
results_all <- rbind(
...
cat("Threshold:", best_threshold, "\n\n")

# Get correct prob vector
pred_probs <- switch(
  best_model_name,
  ...
  "ANN"           = ann_test_prob,
  "Baseline (No Model)" = rep(0, length(y_test)),
