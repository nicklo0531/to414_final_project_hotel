...
source("data/data_cleaning_splitting.R") 
source("models/LogisticRegression.R") 
source("models/KNN.R")                  # produces knn_train_prob & knn_test_prob
source("models/DecisionTree.R")        # produces c50_model, pred_c50_prob
source("models/RandomForest.R")        # produces rf_train_prob & rf_test_prob
source("models/SVM.R")                  # produces svm_train_prob & svm_test_prob
source("models/ANN.R")           # produces ann_train_prob & ann_test_prob
source("models/metaDecTr.R")
```
